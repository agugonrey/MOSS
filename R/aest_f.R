...
#' @param x Character vector with labels or a numerical vector split in 'n.cat' categories.
#' @param n.cat Number of categories to split vector 'x'. Numeric. Ignored if is(x,'character')=TRUE.
#' @param option Controls color palette. One of the possible 'option' arguments for the 'viridis' function.
#' @return A data.frame with labels as rownames and two columns representing point colors and shape.
#' @export
